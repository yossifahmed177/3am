...
✤ --gRole RoleName | Show The stats of the role
...
✠ --mute | Msg Everyone In The Server

✠ --tempban | Kick With Reson
 
✠ --warn | Ban With Reason
 
✠ --bc | BroadCast

✠ --cc Number | Create colors with number like #cc 100 this will create for you 100 color
─════════════════════════════─
   `]
    let page = 1;
