...
.setColor("#9B59B6")
.addField(" ** :gear: Server Support :gear: **" , "  **https://discord.gg/yqCEnKm**")
...
client.on('message', message => {
    ...
    .setTitle(`Click Here To Add BuDerBot `)
    .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=512594180292345856&permissions=0&scope=bot`)
 ...
 **
─════════════════════════════─
 ─═══════ {✯:wrench: اومر البوت العام  :wrench:✯} ═══════─
✤
...
client.login("NTEyNTk0MTgwMjkyMzQ1ODU2.Ds7ucQ.HmOQBLZKoF26zeqgpQscsz4TG1U");